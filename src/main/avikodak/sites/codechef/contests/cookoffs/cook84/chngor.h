/****************************************************************************************************************************************************
 *  File Name                   : chngor.h
 *  File Location               : /algos_v3/src/main/avikodak/sites/codechef/contests/cookoffs/cook84/chngor.h
 *  Created on                  : Jul 25, 2017 :: 3:53:45 PM
 *  Author                      : avikodak
 *  Testing Status              : TODO
 *  URL                         : TODO
 ****************************************************************************************************************************************************/
...
#ifndef MAIN_AVIKODAK_SITES_CODECHEF_CONTESTS_COOKOFFS_COOK84_CHNGOR_H_
#define MAIN_AVIKODAK_SITES_CODECHEF_CONTESTS_COOKOFFS_COOK84_CHNGOR_H_
...
void solveProblem() {
    ...
    while (testCases--) {
        ...
        for (int counter = size - 1; counter >= 0; counter--) {
            result += (result | userInput[counter]);
        }
        printf("%d\n", result);
    }
}

#endif /* MAIN_AVIKODAK_SITES_CODECHEF_CONTESTS_COOKOFFS_COOK84_CHNGOR_H_ */
